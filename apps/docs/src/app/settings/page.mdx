...
> [!NOTE]
>
> VSCode VDF will automatically attempt to locate your `Team Fortress 2` folder via Steam based on your operating system by checking:
> <Tabs items={["Windows", "Linux"]}>
> <Tabs.Tab>
> 	The registry key:
>
> 	 - `HKEY_LOCAL_MACHINE\SOFTWARE\Valve\Steam` (x86)
> 	 - `HKEY_LOCAL_MACHINE\SOFTWARE\WOW6432Node\Valve\Steam` (x64)
>
> 	`InstallPath`
> 	<br />
> </Tabs.Tab>
> <Tabs.Tab>
> 	The directories:
> 	1. `$HOME/.local/share/Steam`
> 	2. `$HOME/.steam/steam`
> 	3. `$HOME/.var/app/com.valvesoftware.Steam/.local/share/Steam`
> </Tabs.Tab>
> </Tabs>
>
...
> [!CAUTION]
>
> If Team Fortress 2 installation is not found, you will be prompted to select the path to your `Team Fortress 2` folder
>
> If you do not have Team Fortress 2 installed, click `Don't show again` or set `teamFortress2Folder` to `""`
...
> [!NOTE]
>
> The currently supported VTF image formats are
>
> `RGBA8888`\
> `ABGR8888`\
> `RGB888`\
